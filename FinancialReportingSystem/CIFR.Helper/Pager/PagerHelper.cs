...
namespace CIFR.Helper.Pager
{
    public static class PagerHelper
    {
        ...
        {
            return Pager(helper, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, actionName, controllerName, null, null, null, null);
        }

        public static MvcHtmlString Pager(this HtmlHelper helper, IPagedList pagedList, string actionName, string controllerName, object routeValues)
        {
            return Pager(helper, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, actionName, controllerName, null, null, routeValues, null);
        }
        ...
        public static MvcHtmlString AjaxPager(this HtmlHelper html, IPagedList pagedList, object routeValues, string updateContainer = "list-container")
        {
            if (pagedList == null)
                return AjaxPager(html, (PagerOptions)null, null);
            return AjaxPager(html, pagedList.TotalItemCount, pagedList.PageSize, pagedList.CurrentPageIndex, null, null, null, null, routeValues, new AjaxOptions { UpdateTargetId = updateContainer },
                             null);
        }
